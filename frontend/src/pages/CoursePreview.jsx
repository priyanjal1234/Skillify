...
const CoursePreview = () => {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <div
        className={`shadow ${darkMode ? "bg-gray-800" : "bg-white"} transition-colors`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className={`px-6 py-2 rounded-lg transition-colors flex items-center space-x-2 ${courseStatus === "Published" || specificCourse?.lessons?.length === 0 ? "bg-gray-400 cursor-not-allowed" : "bg-green-600 hover:bg-green-700 text-white"}`}
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div
            className={`rounded-2xl p-6 shadow-sm ${darkMode ? "bg-gray-800" : "bg-white"}`}
          >
            ...
            <div className="space-y-4">
              {Array.isArray(specificCourse?.lessons) &&
                specificCourse?.lessons?.map((chapter, index) => (
                  <div
                    key={index}
                    className={`border rounded-xl p-4 transition-colors duration-200 ${darkMode ? "border-gray-700 hover:bg-gray-700" : "border-gray-200 hover:bg-gray-50"}`}
                  >
