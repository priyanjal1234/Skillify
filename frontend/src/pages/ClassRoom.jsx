      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {selectedLecture && selectedLecture.description && (
            <div
              className={`p-6 rounded-2xl shadow-sm ${darkMode ? "bg-gray-800" : "bg-white"}`}
            >
          ...
          <div className="space-y-2 overflow-auto">
            {course?.lessons?.map((lesson, index) => (
              <div
                ...
                key={index}
                className={`cursor-pointer relative ${showModal && "pb-4"} overflow-hidden border rounded-xl transition-colors duration-200 ${darkMode ? "border-gray-700 hover:bg-gray-700" : "border-gray-200 hover:bg-gray-50"}`}
              >
